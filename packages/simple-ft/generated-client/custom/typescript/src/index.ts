 ...
 *
 */
export type  = U128 | AccountId | FTMetadataVersion | FtMetadataName | FTMetadataSymbol | FTMetadataReference | FTMetadataReferenceHash | FTMetadataDecimals | Memo | BooleanVyG3AETh | TokenIds | NullQu0Arl1F | FTMetadata | StorageBalanceBoundsObject | StorageBalance | UnorderedSetOfBooleanVyG3AETheht2BVDp;
export type Mint = (amount: U128) => Promise<NullQu0Arl1F>;
export type IsInit = () => Promise<BooleanVyG3AETh>;
export type New = (owner_id: AccountId, total_supply: U128, version: FTMetadataVersion, name: FtMetadataName, symbol: FTMetadataSymbol, reference: FTMetadataReference, reference_hash: FTMetadataReferenceHash, decimals: FTMetadataDecimals) => Promise<NullQu0Arl1F>;
...
export type StorageWithdraw = (token_ids: TokenIds, amount: U128) => Promise<StorageBalance>;
  ...
  type GTMint = [...Parameters<Mint>, ChangeMethodOptions?]
  type RTMint = ReturnType<Mint>
...
export class SimpleFT {
  ...
  /**
   * Mint some tokens for simple contract
   * 
   */
  // tslint:disable-next-line:max-line-length
  public mint(amount: U128, options?: ChangeMethodOptions): RTMint { 
    ...
    return (this.contract as any).mint({args: paramByName, ...options}) as RTMint 
    }

    return (this.contract as any).mint({args: paramByName}) as RTMint 
  }
   ...
   */
  // tslint:disable-next-line:max-line-length
  public new(owner_id: AccountId, total_supply: U128, version: FTMetadataVersion, name: FtMetadataName, symbol: FTMetadataSymbol, reference: FTMetadataReference, reference_hash: FTMetadataReferenceHash, decimals: FTMetadataDecimals, options?: ChangeMethodOptions): RTNew { 
